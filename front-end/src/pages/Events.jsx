...
const events = [
  { date: '2024-09-02', title: 'Cansu Yıldıran: Haunt the Present | Presented by Protocinema', description: 'An opening reception for the new modern art exhibit.', imageSrc: artistPic },
  { date: '2024-09-21', title: 'Tropical Frequencies Exhibition Tour, Dance Workshop and Experimental Performance Show', description: 'Conducted as a follow-along with guided improvisation, DIDIDADA celebrates nonsensical play with accessible, multidisciplinary exercises. It focuses on catharsis, reconnecting with the body, and the joy of movement through dance inspired by Caribbean styles, fitness, and somatic practices.', imageSrc: 'https://lmcc.net/wp-content/uploads/2024/09/Coco-Villa_Credit-Olu-Okiemute.jpg' },
  { date: '2024-09-21', title: 'Hope is a dicipline Exhibition Tour and Artist Talk', description: "Wong's installation, The Red what reading did re-adding, examines the League of Revolutionary Struggle using material from Unity Newspaper (2024), blending historical content with new writing and interviews. Inspired by Amiri Baraka, it reflects on how political inheritance influences our understanding of history.", imageSrc: anotherPic },
  { date: '2024-04-30', title: 'The Power of Bounce', description: 'Miguel Gutierrez presents an interactive dance performance featuring group choreography, aerobics, and costumes. Participants are encouraged to wear costumes and learn the famous “Aerobicon” dance, creating a powerful public spectacle that celebrates movement, joy, and resilience amidst everyday challenges.', imageSrc: somePic },
  { date: '2024-09-09', title: 'Grantee Events', description: 'TWEED TheaterWorks presents Garden Variety, a free performance series at historic community space 6&B Garden in the East Village. This summer’s series will include music and performance by artists including Ms. Zilbert & Co., Julian Fleisher, Rebecca Havemayer, Angela DeCarlo, Lacy Rose and her Starling Quartet, and Dane Terry. Join us on July 23, August 27, and September 3, 10, & 17 (rain date each following Thursday).', imageSrc: GranteePic },
  { date: '2024-08-08', title: 'Teach Me What Love Is', description: '"Teach Me What Love Is" is a participatory performance and karaoke workshop that explores the meaning of "love" across different languages. It highlights the experiences of ESL speakers and examines the nuances of language and translation through the shared cultural experience of love songs.', imageSrc: TeachMe },
  { date: '2024-08-08', title: 'I Love NY: Augmented Reality Edition', description: 'I Love NY: Augmented Reality Edition is a free two-day class that teaches participants to create augmented reality artworks by transforming their physical surroundings using accessible 3D modeling tools. Led by Sacha Alexandra, attendees will explore New York City through animation and leave with personalized 3D artwork, while also gaining skills to use this technology for creative projects.', imageSrc: Augmented },
];
